                    ...
                    <tbody>
                        ...
                        {ostatnieTrasy.dane.map((wi) => {
                            ...
                            <tr key={"trasa_"+wiersz.id}>
                                ...
                                <td>
                                    {skad && (wiersz.gra ? <img className="flaga" title={skad.kraj} src="/img/flagi/usa.png" /> : <img title={skad.kraj} className="flaga" src={"/img/flagi/"+skad.kraj.toLowerCase().replaceAll("ó", "o").replaceAll("ń", "n").replaceAll("ł", "l").replaceAll(" ", "").replaceAll("ś", "s").replaceAll("ę", "e").replaceAll("ż", "z").replaceAll("ą", "a").replaceAll("ź", "z").replaceAll("ć", "c")+".png"} /> )}
                                    <b>{skad ? skad.miasto : "???"}</b>
                                    <HiArrowNarrowRight />
                                    {dokad && (wiersz.gra ? <img className="flaga" title={dokad.kraj} src="/img/flagi/usa.png" /> : <img title={dokad.kraj} className="flaga" src={"/img/flagi/"+dokad.kraj.toLowerCase().replaceAll("ó", "o").replaceAll("ń", "n").replaceAll("ł", "l").replaceAll(" ", "").replaceAll("ś", "s").replaceAll("ę", "e").replaceAll("ż", "z").replaceAll("ą", "a").replaceAll("ź", "z").replaceAll("ć", "c")+".png"} /> )}
