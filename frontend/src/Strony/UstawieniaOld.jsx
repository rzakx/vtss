...
export default function UstawieniaOld(props){
    ...
    const [ stawkiPaliwowe, setStawkiPaliwowe] = useState({response: false, dane: null, open: false});
    const [ edytowanaStawka, setEdytowanaStawka] = useState({name: null, stawka: null});
    let tmpX = 0;
                    ...
                    <div className="ustawieniaMain">
                       <div className="ustawieniaKol">
                        ...
                        <div className="ustawieniaKol" style={{justifyContent: 'space-evenly'}}>
                            <h2>Baza danych gry</h2>
                            <span style={{fontStyle: 'italic', textAlign: 'center'}}>Aby otworzyć zarządzanie<br/> poszczególną kategorią<br/>kliknij w poniższy przycisk.</span>
                            <div style={{display: 'flex', gap: 10}}>
                                <button style={{width: 'fit-content', margin: 0}} onClick={() => setMiasta({...miasta, open: !miasta.open})}>Miejscowości</button>
                                <button style={{width: 'fit-content', margin: 0}} onClick={() => setPromy({...promy, open: !promy.open})}>Promy</button>
                                <button style={{width: 'fit-content', margin: 0}} onClick={() => setPromy({...promy, open: !promy.open})}>Stawki</button>
                            </div>
                        </div>
                        <div className="ustawieniaKol"><div className="slupeczek" /></div>
                        <div className="ustawieniaKol">
