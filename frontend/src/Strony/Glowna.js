				...
				<div className="glowna">
						...
						<div className="miniProfil">
							...
							<div className="miniDane">
								<div>
									...
									<span>{localStorage.getItem('typkontaNazwa')}<br /><span style={{fontSize: '0.9rem'}}>{localStorage.getItem('stanowiskoNazwa')}</span></span>
								</div>
								<div>
									<span>Stan konta: { stanKonta ? stanKonta.toLocaleString("pl-PL", {style: 'currency', currency: "PLN"}) : "0,00 zł"}</span>
								</div>
								<div>
					...
					<div className="glownaDol">
						...
						<div className="statfirmowa">
							...
							<span className="statKontoFirmowe">Konto firmowe<br/><b>{kontoFirmowe.response ? kontoFirmowe.suma.toLocaleString('pl-PL', {style: 'currency', currency: 'PLN'}) : dostanStanFirmy()}</b></span>
						</div>
					</div>
				</div>
			</div>
